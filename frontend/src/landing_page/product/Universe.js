  ...
  return ( 
   <div className='container mt-5 p-5'>
    <div className='row text-center'>
      <h1 className='fs-4'>Want to know more about our technology stack? Check out the <a href="" style={{textDecoration:"none"}}>Zerodha.tech </a>blog.</h1>
      ...
      <button className='p-2 btn btn-primary fs-5' style={{width:"15%", margin:"0 auto",}}>Signup Now</button>
    </div>
